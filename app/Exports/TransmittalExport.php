...
class TransmittalExport implements FromView
{
    ...
    public function __construct($transmitted_date, $transmittal_date_from, $transmittal_date_to, $transmittal_status)
    {
        ...
        $this->transmitted = Health::
        whereHas('transmittals', function ($query) {

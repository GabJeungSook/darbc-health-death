...
class DeathUnpaidExport implements FromView
{
    public $encoded_date;
    public $date_from;
    public $date_to;
    ...
    public function __construct($encoded_date, $date_from, $date_to, $vehicle,$diamond_package, $coverage_type, $enrollment_status)
    {
        ...
        $this->death = Death::where('status', 'UNPAID')->when($this->date_from && $this->date_to, function ($query) {
    ...
    */
    ...
    {
        return view('exports.death-unpaid', [
            'unpaid' => $this->death,
        ]);
    }
}
